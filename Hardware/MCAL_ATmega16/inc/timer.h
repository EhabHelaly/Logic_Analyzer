...
#define TIMER_MODE_PWM      0x02
#define TIMER_MODE_CTC      0x04
#define TIMER_MODE_FAST_PWM 0x08

#define TIMER_COM_OFF       0x10
...
_INLINE_ u32  Timer_Capture(u8 timer);
...
_INLINE_ u32 Timer_Capture(u8 timer)
{
    switch(timer)
    {
        ...
        case PERIPHERAL_TIMER_1: {return Timer1_Capture(); break;}
